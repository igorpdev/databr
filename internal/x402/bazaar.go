...
var routeMeta = map[string]routeMetaEntry{
	...
	"/v1/judicial/processos/{doc}":     {"Processos judiciais por CPF/CNPJ (DataJud CNJ, 91 tribunais)", "application/json"},
	"/v1/judicial/processo/{numero}":   {"Busca direta de processo judicial por número CNJ unificado (91 tribunais)", "application/json"},
	...
	"/v1/saude/estabelecimentos/{cnes}":     {"Estabelecimento de saúde por código CNES (DATASUS)", "application/json"},
	"/v1/saude/estabelecimentos":            {"Estabelecimentos de saúde por município ou UF (DATASUS)", "application/json"},
