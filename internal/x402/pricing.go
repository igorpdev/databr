...
var priceTable = map[string]string{
	...
	"/v1/tributario/ncm/{codigo}":               "0.003",
	"/v1/tributario/icms/{uf}":                  "0.003",
	"/v1/tributario/icms":                       "0.003",
	"/v1/transparencia/pgfn":                    "0.003",
	"/v1/transparencia/pep":                     "0.003",
	"/v1/transparencia/leniencias":              "0.003",
